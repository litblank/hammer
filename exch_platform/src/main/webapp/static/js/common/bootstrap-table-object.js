 ...
 */
(function () {
    var BSTable = function (bstableId, url, columns, clickrow) {
        ...
        this.mclickToSelect = true;			//默认分页方式是服务器分页,可选项"client"
        this.toolbarId = bstableId + "Toolbar";
        this.columns = columns;
        this.height = 665;						//默认表格高度665
        this.data = {};
        this.queryParams = {}; // 向后台传递的自定义参数
        this.ionClickRow=clickrow;
    };
    ...
    BSTable.prototype = {
        ...
        init: function () {
            ...
            this.btInstance =
                $('#' + tableId).bootstrapTable({
                    ...
                    clickToSelect: this.mclickToSelect,    	//是否启用点击选中行
         ...
         * 设置是否点击行选中
         */
        setClickToSelect: function (bool) {
            this.mclickToSelect = bool;
        },
