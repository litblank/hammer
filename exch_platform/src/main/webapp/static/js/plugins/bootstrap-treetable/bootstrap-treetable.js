            ...
            $.each(options.columns, function (index, column) {
                ...
                if (index == 0 && column.field == 'selectItem') {
                    ...
                    if(column.visible==false){
                        td = $('<td hidden="hidden" title="' + item[column.field] + '" name="' + column.field + '" style="' + ((column.width) ? ('width:' + column.width) : '') + '"></td>');
                    }else{
                        td = $('<td title="' + item[column.field] + '" name="' + column.field + '" style="' + ((column.width) ? ('width:' + column.width) : '') + '"></td>');
                    }
                    // 增加formatter渲染
                    if (column.formatter) {
            ...
            $.each(options.columns, function (i, item) {
                ...
                if (i == 0 && item.field == 'selectItem') {
                    ...
                    if(item.visible==false){
                        th = $('<th hidden="hidden" style="' + ((item.width) ? ('width:' + item.width) : '') + '"></th>');
                    }else{
