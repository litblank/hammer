package com.exch.platform.config.properties;
...
public class GunsFlowableProperties {
     ...
     * 默认多数据源的链接
     */
    private String url = "jdbc:mysql://127.0.0.1:3306/exch?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull";
