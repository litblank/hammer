...
import static com.exch.platform.core.common.constant.factory.MutiStrFactory.*;
...
public class DictServiceImpl extends ServiceImpl<DictMapper, Dict> implements IDictService {
    ...
    public void addDict(String dictCode, String dictName, String dictTips, String dictValues) {
        ...
        for (Map<String, String> item : items) {
            ...
            String tips = item.get(MUTI_STR_TIPS);
            Dict itemDict = new Dict();
            itemDict.setPid(dict.getId());
            itemDict.setCode(code);
            itemDict.setName(name);
            itemDict.setTips(tips);
    ...
    @Override
    public List<Map<String, Object>> listDict(Map parm) {
        return dictMapper.listDict((HashMap<String,Object>)parm);
    }
}
