package com.exch.platform.modular.flowable.service.impl;
...
import com.exch.platform.core.util.HttpKit;
import com.exch.platform.modular.flowable.model.TaskVo;
import com.exch.platform.modular.flowable.service.IExpenseService;
import com.exch.platform.modular.system.dao.ExpenseMapper;
import com.exch.platform.modular.system.model.Expense;
...
public class ExpenseServiceImpl extends ServiceImpl<ExpenseMapper, Expense> implements IExpenseService {
    ...
    public void pass(String taskId) {
        ...
        ProcessInstance pi = runtimeService.createProcessInstanceQuery()//
                ...
                .singleResult();
        Wrapper<Expense> wrapper = new EntityWrapper<Expense>().eq("process_id", task.getProcessInstanceId());
