...
import com.exch.platform.core.common.constant.dictmap.UserDict;
...
import com.exch.platform.modular.system.factory.UserFactory;
import com.exch.platform.modular.system.model.User;
import com.exch.platform.modular.system.service.IUserService;
import com.exch.platform.modular.system.transfer.UserDto;
import com.exch.platform.modular.system.warpper.UserWarpper;
...
public class UserMgrController extends BaseController {
    ...
    @Autowired
    private ExchProperties exchProperties;
     ...
     * 跳转到角色对应的用户页面
     */
    @RequestMapping("/assignUserTo/{roleId}")
    public String assignUserToView(@PathVariable Integer roleId, Model model) {
        model.addAttribute("roleId", roleId);
        return PREFIX + "assignUser.html";
    }
    ...
    public String upload(@RequestPart("file") MultipartFile picture) {
        ...
        try {
            String fileSavePath = exchProperties.getFileUploadPath();
    ...
    @ResponseBody
    public Object assignUser(@PathVariable Integer roleId, Model model) {
        if (ToolUtil.isEmpty(roleId)) {
            throw new ServiceException(BizExceptionEnum.REQUEST_NULL);
        }

        Wrapper<User> wrapper=new EntityWrapper();
        wrapper.like("roleid",roleId.toString(), SqlLike.CUSTOM);
        wrapper.or();
        wrapper.like("roleid",roleId.toString()+",%", SqlLike.CUSTOM);
        wrapper.or();
        wrapper.like("roleid","%,"+roleId.toString()+",%", SqlLike.CUSTOM);
        wrapper.or();
        wrapper.like("roleid","%,"+roleId.toString(), SqlLike.CUSTOM);
        List<Map<String, Object>> userlist=this.userService.selectMaps(wrapper);

        return new UserWarpper(userlist).wrap();
    }
}
