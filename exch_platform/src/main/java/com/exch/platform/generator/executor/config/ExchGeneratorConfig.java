 ...
 *
 */
public class ExchGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void dataSourceConfig() {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://127.0.0.1:3306/exch?characterEncoding=utf8");
    }
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.exch.platform.admin.common.persistence.model");
        packageConfig.setMapper("com.exch.platform.admin.common.persistence.dao");
        packageConfig.setXml("com.exch.platform.admin.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.exch.platform.admin");
        contextConfig.setCoreBasePackage("com.exch.platform.core");
        contextConfig.setBizChName("字典管理");
        contextConfig.setBizEnName("sysDict");
        contextConfig.setModuleName("system");
        contextConfig.setProjectPath("D:\\ideaSpace\\exch\\exch-admin");//写自己项目的绝对路径
