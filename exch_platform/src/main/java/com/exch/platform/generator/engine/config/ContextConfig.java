package com.exch.platform.generator.engine.config;
...
public class ContextConfig {
    private String author;//Control作者

    private String templatePrefixPath = "exchTemplate/advanced";
    private String projectPath = "D:\\ideaSpace\\exch";//模板输出的项目目录
    ...
    private String proPackage = "com.exch.platform.admin";
    private String coreBasePackage = "com.exch.platform.core";
    private String modelPackageName = "com.exch.platform.modular.system.model";        //model的包名
    private String modelMapperPackageName = "com.exch.platform.modular.system.dao";    //model的dao
    ...
    public void init() {
        ...
        modelMapperPackageName = proPackage + "." + "modular."+moduleName+".mapper";
    }
